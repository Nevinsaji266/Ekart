          ...
          <div className='md:grid grid-cols-[2fr_1fr] my-10'>
            ...
            <div className='pt-5 px-10'>
              <div className='p-5 shadow-lg'>
                ...
                <button  onClick={handleCheckout} className='w-full bg-green-600 text-white p-3 mt-4 hover:bg-white hover:border hover:border-green-600 hover:text-green-600 transition duration-300 ease-in '>
                  Checkout
                </button>
